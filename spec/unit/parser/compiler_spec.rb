...
describe Puppet::Parser::Compiler do
  ...
  it "fails if the node's environment has conflicting manifest settings" do
    ...
    expect { Puppet::Parser::Compiler.compile(@node) }.to raise_error(Puppet::Error, /configured.*with.*restrict_environment_manifest.*true.*environment.conf.*manifest setting.*conflict/)
  end
